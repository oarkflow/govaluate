...
func parseTokens(expression string, functions map[string]ExpressionFunction, onlyUnexported bool) ([]ExpressionToken, error) {
	...
	for stream.canRead() {
		...
		token, err, found = readToken(stream, state, functions, onlyUnexported)
...
func readToken(stream *lexerStream, state lexerState, functions map[string]ExpressionFunction, onlyUnexported bool) (ExpressionToken, error, bool) {
